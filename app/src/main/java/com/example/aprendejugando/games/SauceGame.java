...
public class SauceGame extends AppCompatActivity {
    ...
    private static ArrayList <Blob_list> list_of_blobs = new ArrayList<Blob_list>();
    private Timer timer;
    private static Integer difficulty_level=1;
    private Integer max_blob_cuantity;
    private Integer actual_blobs=1;
    private Integer score=0;
    private SauceGame this_game;
    private final Integer GAME_TIME=15;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dog_dialogue = findViewById(R.id.sauce_game_dog_dialogue);
        dog_image = findViewById(R.id.sauce_game_img_dog);
        ...
        blob_count_text=findViewById(R.id.sauce_game_blob_counter);
        ...
        this_game=this;
        timer = new Timer(GAME_TIME,timer_text, this_game,starter_blob_add_ammount,difficulty_level);
    }

    private void initalizeblobs() {
        blob1=findViewById(R.id.sauce_game_blob1);
        blob2=findViewById(R.id.sauce_game_blob2);
        blob3=findViewById(R.id.sauce_game_blob3);
        blob4=findViewById(R.id.sauce_game_blob4);
        blob5=findViewById(R.id.sauce_game_blob5);
        blob6=findViewById(R.id.sauce_game_blob6);
        blob7=findViewById(R.id.sauce_game_blob7);
        blob8=findViewById(R.id.sauce_game_blob8);
        blob9=findViewById(R.id.sauce_game_blob9);
        blob10=findViewById(R.id.sauce_game_blob10);
        blob11=findViewById(R.id.sauce_game_blob11);
        blob12=findViewById(R.id.sauce_game_blob12);
        hide_all_blobs();
            ...
            public void run() {
                switch (blob_id) {
                    case 1:
                        ...
                        blob1.setTranslationY((int) (Math.random()*1000+30));
                        blob1.setVisibility(View.VISIBLE);
                        View view1= findViewById(R.id.sauce_game_blob1);
                        view1.setAlpha(1);
                        list_of_blobs.get(0).setAdded_already(true);
                        actual_blobs++;
                        break;
                    case 2:
                        ...
                        blob2.setTranslationY((int) (Math.random()*1000+30));
                        blob2.setVisibility(View.VISIBLE);
                        View view2= findViewById(R.id.sauce_game_blob2);
                        view2.setAlpha(1);
                    ...
                    case 3:
                        ...
                        blob3.setTranslationY((int) (Math.random()*1000+30));
                        blob3.setVisibility(View.VISIBLE);
                        View view3= findViewById(R.id.sauce_game_blob3);
                        view3.setAlpha(1);
                    ...
                    case 4:
                        ...
                        blob4.setTranslationY((int) (Math.random()*1000+30));
                        blob4.setVisibility(View.VISIBLE);
                        View view4= findViewById(R.id.sauce_game_blob4);
                        view4.setAlpha(1);
                    ...
                    case 5:
                        ...
                        blob5.setTranslationY((int) (Math.random()*1000+30));
                        blob5.setVisibility(View.VISIBLE);
                        View view5= findViewById(R.id.sauce_game_blob5);
                        view5.setAlpha(1);
                    ...
                    case 6:
                        ...
                        blob6.setTranslationY((int) (Math.random()*1000+30));
                        blob6.setVisibility(View.VISIBLE);
                        View view6= findViewById(R.id.sauce_game_blob6);
                        view6.setAlpha(1);
                    ...
                    case 7:
                        ...
                        blob7.setTranslationY((int) (Math.random()*1000+30));
                        blob7.setVisibility(View.VISIBLE);
                        View view7= findViewById(R.id.sauce_game_blob7);
                        view7.setAlpha(1);
                    ...
                    case 8:
                        ...
                        blob8.setTranslationY((int) (Math.random()*1000+30));
                        blob8.setVisibility(View.VISIBLE);
                        View view8= findViewById(R.id.sauce_game_blob8);
                        view8.setAlpha(1);
                    ...
                    case 9:
                        ...
                        blob9.setTranslationY((int) (Math.random()*1000+30));
                        blob9.setVisibility(View.VISIBLE);
                        View view9= findViewById(R.id.sauce_game_blob9);
                        view9.setAlpha(1);
                    ...
                    case 10:
                        ...
                        blob10.setTranslationY((int) (Math.random()*1000+30));
                        blob10.setVisibility(View.VISIBLE);
                        View view10= findViewById(R.id.sauce_game_blob10);
                        view10.setAlpha(1);
                    ...
                    case 11:
                        ...
                        blob11.setTranslationY((int) (Math.random()*1000+30));
                        blob11.setVisibility(View.VISIBLE);
                        View view11= findViewById(R.id.sauce_game_blob11);
                        view11.setAlpha(1);
                    ...
                    case 12:
                        ...
                        blob12.setTranslationY((int) (Math.random()*1000+30));
                        blob12.setVisibility(View.VISIBLE);
                        View view12= findViewById(R.id.sauce_game_blob12);
                        view12.setAlpha(1);
                ...
                blob_count_text.setText("Manchas acumuladas: "+actual_blobs+"/"+max_blob_cuantity);
